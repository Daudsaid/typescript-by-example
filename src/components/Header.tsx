...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 h-14 bg-[#3178c6] dark:bg-[#235a97] shadow-md">
      <div className="flex items-center justify-between h-full px-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className={`flex items-center gap-2 transition-opacity duration-200 ${
              isOpen ? "opacity-0 pointer-events-none lg:opacity-0" : "opacity-100"
            }`}
          >
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <a
            ...
            className="px-3 py-1.5 text-sm font-medium text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-colors flex items-center gap-1"
          >
            Official Docs
